...
| Series Planner — macro/architect series planning (5-tab workbench, create-then-update, study-guide export) | [`docs/SYSTEMS/series-planner.md`](docs/SYSTEMS/series-planner.md) | [`docs/PROPOSALS/series-planner-revival-charter.md`](docs/PROPOSALS/series-planner-revival-charter.md) for the what & why / decisions |
