  ...
  async function generateMPS() {
    ...
    try {
      ...
      const resp = await sendAIMessage(
        ...
        "You are a homiletics consultant helping a pastor bridge the MPT to a present-tense sermon claim. The MPS must grow directly from the MPT — not be imposed from outside. Resist the pull to open with the theological answer; when pastoral context is present, the MPS should enter the congregation's cultural world first, narrow to who is in the room, then land the text's claim — moving from the outside in. When the text has sequential logic, express it as a chain where each clause causes the next — not as inventory. The sentence should have a single grammatical spine; everything else is subordinate and in motion."
      );
