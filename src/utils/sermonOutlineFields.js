...
// Drafted from the CCE/Merida source (memory: project_cce_merida_source, Step 3),
// then walked and ratified — "Sermon Outline" ratified as the named outcome's
// name in the same walk. Rulings of record:
...
export const SERMON_OUTLINE_FIELDS = [
  {
    ...
    overview: {
      ...
      paragraphs: [
        ...
        "Three traps to avoid: a clever outline that draws attention to itself (a little alliteration is spice — too much makes you sick); an outline imposed on the text (three points where the text has two); and predictability — the same shape every week. Let the text set the number of points and the shape of the movement.",
      ],
    },
    questions: [
      {
