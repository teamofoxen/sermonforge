...
- ${CONTEXT_SECTIONS.THIS_SERMON}: Pastoral Context for this specific sermon. Two fields: The Room is who in this congregation the text is speaking into — specific people or situations, believers and unbelievers, the wearied, the doubting, the new, the long-faithful. The Sermon's Work is what this text holds out for those specific people — the cost (what will be hard, counter-intuitive) and the gift (the comfort, hope, freedom this text offers). Use The Room to shape application specificity and tone. Use The Sermon's Work to orient how the text lands pastorally. Present at every step — weight appropriately alongside the text.
