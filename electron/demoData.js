...
const sermon1 = {
  ...
  date: "2026-01-04",
  stage: "writing",
  big_idea: "The blessed life is not a life of achievement but of radical dependence — the poor in spirit, the mourners, the meek inherit the kingdom not because they earned it but because they have nothing left to bring.",
...
const sermon2 = {
  ...
  date: "2026-01-11",
  stage: "outline",
  big_idea: "Jesus does not tell his people to try to be salt and light — he declares that they already are. The call is not to manufacture influence but to be who you are without apology or dilution.",
...
const sermon3 = {
  ...
  date: "2026-01-18",
  stage: "study",
  big_idea: "Jesus is not making the law stricter — he is revealing what the law was always after: a transformed heart, not just a restrained hand.",
...
const sermon4 = {
  ...
  date: "2026-01-25",
  stage: "study",
  big_idea: "The devotional life Jesus describes — giving, prayer, fasting — is oriented entirely toward a God who sees in secret. The moment it is performed for any other audience, it has achieved its only reward.",
...
const sermon5 = {
  ...
  date: "2026-02-01",
  stage: "outline",
  big_idea: "Anxiety is not a personality type — it is a sign of misplaced worship. Jesus does not call us to positive thinking but to a reordered heart: one that has found its treasure, fixed its vision, and given its allegiance to a single master.",
...
const sermon6 = {
  ...
  date: "2026-02-08",
  stage: "planning",
  big_idea: "The Sermon on the Mount ends not with a summary but with a choice: two gates, two trees, two builders. Jesus is not inviting reflection — he is demanding a response.",
