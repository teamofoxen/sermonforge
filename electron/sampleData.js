...
V. The Gospel That Sends Us (Rom 12–15) — the body, the world, the weak`,
  ...
  // (the sample had no prior outline, so the folded value is the old
  // book_structure text verbatim). book_structure stays as the DB backup and is
  // no longer rendered or exported.
