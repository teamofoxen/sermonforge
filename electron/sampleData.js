...
V. The Gospel That Sends Us (Rom 12–15) — the body, the world, the weak`,
  ...
  book_id: "romans",
  canon_category: "nt_pauline",
  // The book-study / melodic-line series fields (redemptive_context,
  // book_background, book_argument, book_structure, series_motivation,
  // emerging_big_idea) were retired from the writable set in the v27
...
const sermon = {
  ...
  overview: "The second sermon in our Romans series. After 'The Gospel Stated' (Rom 3–4), Romans 5:1-5 shows what that gospel actually does in a believer's life under pressure. Paul's chain — suffering produces endurance, endurance character, character hope — lands on v.5: the hope's weight rests not on your endurance but on God's love already poured into your heart by the Spirit. The passage is a declaration of what is already true of the justified, anchoring their hope under pressure in what God has done, not in what they must muster.",
  // study_guide_note is retired from the writable set (v27, folded into overview)
  // — kept here only as the backup column's seed value.
