...
- **SPIP** — remaining work plus lived-use watch list. [Doc](study-phase-implementation-plan.md).

---

## Working rule

> **Plain English. No dev speak. Every channel — chat, docs, commits, agent prompts.**

The audience is the pastor-user. Drift gets caught and rewritten when noticed.
...
- Something surfaced in real prep → [SPIP § Watch in real prep](study-phase-implementation-plan.md#watch-in-real-prep).
...
- Why is the structure shaped like this → [SPRD](study-phase-redesign.md).
