...
> **⛔ HISTORICAL RECORD — authority transferred to CORE + WORKSPACE-CANON (Workspace Re-Foundation, 2026-06-15).** The live authority for the sermon walk is now [`docs/CORE.md`](../CORE.md) (the law) and [`docs/WORKSPACE-CANON.md`](../WORKSPACE-CANON.md) (the walk's what & why — every question, named outcome, completeness policy, Merida tag). This document is the frozen development record of how that shape was reached; it is **not a working guide and no longer binds.** Any "remains binding" / "live" / "production" language below is itself historical (including the StudyTab.jsx field-location notes, long since deleted). Where this doc and CORE/canon differ, CORE/canon win — do not rebuild from here.
...
>
> **Post-workspace-restructure status (2026-05-10):** "Step 2" (MPT/MPS) is now the **Anchor sub-phase** of the new Assembly stage; "Step 5" (Intro/Conclusion) is now the **Frame sub-phase** of Assembly. The structural commitments (anchor fields, named outcomes, handoffs) are unchanged. Where the document says "Step 2 → Step 3 handoff," read it as "Anchor → Outline sub-phase handoff" inside Assembly. The MPT/MPS column (`main_point_pair` v19) and Sermon Frame column (`sermon_frame` v18) are unchanged. See [`workspace-restructure-charter.md`](./workspace-restructure-charter.md).
>
> **Post-era-2 / post-invisible-system status (banner committed by the era-2 charter 2026-05-12; executed 2026-06-10 with invisible-system supersessions added):** Era-2 ruling 8 supersedes this document's "cumulative-table closure at six columns" — the closure is FOUR columns, and the shipped Field 3 unified-canvas refactor (2026-05-05) is the binding shape. Other era-2 supersessions are listed in the era-2 charter. The invisible-system rebuild (closed 2026-05-18) replaced the rendering mechanics adopted from SFDI's Field Pattern (counters, disabled-Next, overview screens) — content commitments stand; do not rebuild the deleted mechanics from this document.
