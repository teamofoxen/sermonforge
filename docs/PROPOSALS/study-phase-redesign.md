...
- **Next:** B1.2 — wire SFDI question sequences into specific Phase 1 fields. Start with the simpler text-prompt fields (Background's 4Q Author/Date/Audience/Genre, Context's 4Q Before/After/Impact/HSI, Surface Questions's 3Q Where/When/How, Possible Implications's 2Q Pressing/Hard-Hopeful). Field 4's three structured-exercise questions land in B1.5 against the A2.x primitives.
