...
> **⛔ HISTORICAL RECORD — authority transferred to CORE + WORKSPACE-CANON (Workspace Re-Foundation, 2026-06-15).** The live authority for the sermon walk is now [`docs/CORE.md`](../CORE.md) (the law) and [`docs/WORKSPACE-CANON.md`](../WORKSPACE-CANON.md) (the walk's what & why — every question, named outcome, completeness policy, Merida tag). This document is the frozen development record of how that shape was reached; it is **not a working guide and no longer binds.** Any "remains binding" / "live" / "production" language below is itself historical (including the `ThroughlineRail` / Isolated-World "shipped" references — that machinery was deleted in the invisible-system rebuild). Where this doc and CORE/canon differ, CORE/canon win — do not rebuild from here.
