...
> **⛔ HISTORICAL RECORD — authority transferred to CORE + WORKSPACE-CANON (Workspace Re-Foundation, 2026-06-15).** The live authority for the sermon walk is now [`docs/CORE.md`](../CORE.md) (the law) and [`docs/WORKSPACE-CANON.md`](../WORKSPACE-CANON.md) (the walk's what & why — every question, named outcome, completeness policy, Merida tag). This document is the frozen development record of how that shape was reached; it is **not a working guide and no longer binds.** Any "remains binding" / "live" / "production" language below is itself historical. Where this doc and CORE/canon differ, CORE/canon win — do not rebuild from here.

> **Post-ARI status (2026-05-09):** SFDI closed before the AI Removal Initiative. Any AI-prompt commitments described below ("AI prompts treat PC as enrichment never as a precondition," etc.) are historical — the AI subsystem was deleted in ARI Phase 8 (2026-05-09), and `src/prompts/study.js` no longer exists. The structural commitments (the throughline, the 25 fields, the 4 named outcomes, the 4 sub-phase boundary handoffs, Process Contract #6) remain binding. Where the charter says "AI prompts read X," read it as "the SpotlightWorksheet question flow surfaces X."
>
> **Post-workspace-restructure status (2026-05-10):** SFDI describes Study Step 1 (Exegesis). The Workspace Restructure collapsed the 4-stage workspace to 3 stages (Study / Assembly / Manuscript) and retired the within-Study Step layer entirely — Study is now just Exegesis, with its existing 4 sub-phases unchanged. The "Step 1" framing in this charter maps directly to the whole of the Study stage today. The 25 fields, 4 named outcomes, and 4 sub-phase boundary handoffs are unchanged; the handoff "out of Study into MPT/MPS" is now "out of Study into Assembly's Anchor sub-phase." See [`workspace-restructure-charter.md`](./workspace-restructure-charter.md).
