...
- docs/PROPOSALS/sfdi-throughline-vision.md — in-session orientation sheet kept in view during walks
...
- docs/PROPOSALS/study-phase-implementation-plan.md — SPIP; per-milestone execution plan for the Study redesign
- docs/PROPOSALS/study-phase-implementation-remediation.md — SPIR; anticipated and surfacing risks plus remediation
